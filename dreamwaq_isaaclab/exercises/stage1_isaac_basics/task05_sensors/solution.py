...
def main() -> None:
    ...
    # ex:begin id=height-scan level=2 stage=stage1_isaac_basics task=광선이 맞은 월드 z 를 '몸통 기준 상대 높이'로 바꾼다
    ...
    height_scan = base_z.unsqueeze(1) - ray_hits_z - BASE_HEIGHT_TARGET
    # ex:end
