...
case "$MODE" in
    base)   TASK="DreamWaQ-Direct-Go2-Base-Play-v0"   ;;
    oracle) TASK="DreamWaQ-Direct-Go2-Oracle-Play-v0" ;;
    waq)    TASK="DreamWaQ-Direct-Go2-Waq-Play-v0"    ;;
    *) echo "Usage: $0 [base|oracle|waq]"; exit 1 ;;
esac

echo "============================================"
echo " DreamWaQ Direct — Watch Mode"
echo " Task:    $TASK"
echo " Envs:    $NUM_ENVS"
echo " Mode:    $MODE"
echo "============================================"
