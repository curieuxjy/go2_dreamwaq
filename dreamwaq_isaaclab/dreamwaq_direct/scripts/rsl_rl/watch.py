...
Usage:
    python watch.py --task=DreamWaQ-Direct-Go2-Base-Play-v0 --num_envs=4
"""
...
parser = argparse.ArgumentParser(description="Watch DreamWaQ env with random policy (Direct).")
parser.add_argument("--num_envs", type=int, default=4, help="Number of environments.")
parser.add_argument("--task", type=str, default="DreamWaQ-Direct-Go2-Base-Play-v0", help="Task name.")
parser.add_argument(
