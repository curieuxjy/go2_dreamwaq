...
def config_go2(Cnfg: Cfg):
    ...
    _ = Cnfg.control
    _.control_type = "P"  # Control type: P
    _.stiffness = {"joint": 25.0}  # [N*m/rad] Joint PD parameters to be adjusted
    _.damping = {"joint": 0.6}  # [N*m*s/rad] Joint PD parameters to be adjusted
