def train_go2(headless=True):
    ...
    writer = SummaryWriter(log_dir="runs/go2_experiment")
    ...
    # Log the experiment parameters to TensorBoard and wandb
    writer.add_text("Experiment Parameters", str(vars(Cfg)))
