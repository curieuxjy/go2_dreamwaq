...
class RolloutStorage:
    ...
    def mini_batch_generator(self, num_mini_batches, num_epochs=8):
        ...
        for epoch in range(num_epochs):
            for i in range(num_mini_batches):
                ...
                yield obs_batch, critic_observations_batch, privileged_obs_batch, obs_history_batch, actions_batch, target_values_batch, advantages_batch, returns_batch, old_actions_log_prob_batch, old_mu_batch, old_sigma_batch, None, env_bins_batch
    ...
    def reccurent_mini_batch_generator(self, num_mini_batches, num_epochs=8):
        ...
        padded_privileged_obs_trajectories, trajectory_masks = (
        ...
        for ep in range(num_epochs):
            ...
            for i in range(num_mini_batches):
                ...
                obs_history_batch = padded_obs_history_trajectories[
                    :, first_traj:last_traj
                ]
                ...
                yield obs_batch, critic_obs_batch, privileged_obs_batch, obs_history_batch, actions_batch, values_batch, advantages_batch, returns_batch, old_actions_log_prob_batch, old_mu_batch, old_sigma_batch, masks_batch
